...
public class AdductDetectionTest {
    ...
    public void shouldDetectAdductBasedOnMzDifference() {
        ...
        annotation = new Annotation(lipid, annotationMZ, annotationIntensity, annotationRT, IoniationMode.POSITIVE, Set.of(mH, mNa));
    ...
    public void shouldDetectLossOfWaterAdduct() {
        ...
        mH = new Peak(700.500, 90000.0);// [M+H]+
        // ~18.0106 Da less
        lipid = new Lipid(1, "PE 36:2", "C41H78NO8P", LipidType.PE, 36, 2);
        annotation = new Annotation(lipid, mH.getMz(), mH.getIntensity(), 7.5d, IoniationMode.POSITIVE, Set.of(mH, mhH2O));
    ...
    public void shouldDetectDoublyChargedAdduct() {
        ...
        annotation = new Annotation(lipid, singlyCharged.getMz(), singlyCharged.getIntensity(), 10d, IoniationMode.POSITIVE, Set.of(singlyCharged, doublyCharged));
